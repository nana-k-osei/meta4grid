...
if __name__ == "__main__":
    #model = PPO.load("../../red_ball_grey_playground/models/ppo_redballgrey_baseline")  # trained RedBallGrey model
    model = PPO.load("../../red_ball_grey_playground/models/ppo_redballgrey_macro_final")  # trained RedBallGrey model
