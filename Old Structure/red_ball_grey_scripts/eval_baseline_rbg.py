...
def make_env_with_video(run_idx):
    def _init():
        ...
        video_folder = f"videos/red_ball_grey/redballgrey_macro_run_{run_idx}_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
...
if __name__ == "__main__":
    ...
    model = PPO.load("../../red_ball_grey_playground/models/ppo_redballgrey_macro_final")
