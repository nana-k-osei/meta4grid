...
def make_env_with_video(run_idx):
    def _init():
        ...
        video_folder = f"videos/red_ball_scripts/redball_macro_run_{run_idx}_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
...
if __name__ == "__main__":
    model = PPO.load("./red_ball_playground/models/ppo_redball_macro_final")
